  ...
  return (
    <View style={styles.container}>
      <View style={styles.toggleContainer}>
        {["Pending", "PaymentDue", "Preparing", "Delivered", "Cancelled"].map(
          (status) => (
            <TouchableOpacity
              key={status}
              style={[
                styles.toggleButton,
                isSelected(status) && styles.activeToggle,
              ]}
            ...
            >
              <Text
                style={[
                  ...
                  isSelected(status) && styles.activeText,
                ]}
              >
                {status}
              </Text>
      ...
      {filteredOrders.length === 0 ? (
        ...
        <FlatList
            ...
            <View style={styles.cardContainer}>
              ...
              <View style={styles.userInfoContainer}>
                <Text style={styles.userInfoText}>
                  User: {item.userName} (+852 {item.userPhone})
                </Text>
              </View>
          ...
          keyExtractor={(item) =>
            item.order_id ? item.order_id.toString() : Math.random().toString()
          }
        />
      )}
          ...
          {["Pending", "PaymentDue", "Preparing", "Delivered", "Cancelled"].map(
            (status) => (
              <Pressable
                ...
                style={[
                  styles.optionButton,
                  currentStatus === status && styles.selectedOption,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.optionText,
                    currentStatus === status && { color: "white" },
                  ]}
                >
                  {status}
                </Text>
